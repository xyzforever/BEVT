...
from .samplers import ClassSpecificDistributedSampler, DistributedSampler, DistributedChunkSampler
    ...
    if dist:
        if sample_by_class:
            ...
            sampler = DistributedChunkSampler(
                dataset, shuffle=shuffle, chunk_sizes=chunk_sizes, rank=rank, num_replicas=world_size
            )
        else:
