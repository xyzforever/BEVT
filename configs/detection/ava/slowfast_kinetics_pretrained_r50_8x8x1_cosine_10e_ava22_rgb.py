...
data_root = 'DATASET/videodata/ava/rawframes'
anno_root = 'DATASET/videodata/ava/annotations'
...
workflow = [('train', 1)]
evaluation = dict(interval=1, gpu_collect=True)
log_config = dict(
    interval=20, hooks=[
...
log_level = 'INFO'
work_dir = 'OUTPUT/ava22/slowfast_kinetics_pretrained_r50_8x8x1_cosine_10e_ava22_rgb'  # noqa: E501
load_from = 'DATASET/dochenpretrained/slowfast/slowfast_r50_8x8x1_256e_kinetics400_rgb_resave_by_torch17.pth'  # noqa: E501
resume_from = None
